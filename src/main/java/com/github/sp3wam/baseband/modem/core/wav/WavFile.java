package com.github.sp3wam.baseband.modem.core.wav;
...
public class WavFile
{
    ...
    private boolean wordAlignAdjust; // Specify if an extra byte at the end of the data chunk is required for
                                     // word alignment
